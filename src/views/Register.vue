              ...
              <div class="container">
                ...
                <form role="form" @submit.prevent="submitSignin">
                  <div class="form-group">
                    <div>
                        <small class="text-uppercase font-weight-bold">Last name:</small>
                      </div>
                    <base-input
                      id="last_name"
                      name="last_name"
                  ...
                  <div class="form-group">
                    <div>
                        <small class="text-uppercase font-weight-bold">First name:</small>
                      </div>
                    <base-input
                      id="first_name"
                      name="first_name"
                  ...
                  <div class="form-group">
                    <div>
                        <small class="text-uppercase font-weight-bold">Password:</small>
                      </div>
                    <base-input
                      id="password"
                      name="password"
                  ...
                  <div class="form-group">
                    <div>
                        <small class="text-uppercase font-weight-bold">Birthdate:</small>
                      </div>
                    <base-input
                      id="birthdate"
                      name="birthdate"
